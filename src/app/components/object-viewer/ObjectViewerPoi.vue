	...
	<div @click.prevent.stop="openFullscreen" ref="renderContainer" class="objViewer">
		...
		<div ref="poiWrapper" class="poi-wrapper" :class="{
			...
			<slot name="poi" :poi="poi" :isActive="(activePOIIndex === index)">
				<div class="objViewer_poi_wrapper">
		...
		<div v-if="activePOIData" class="objViewer_info-overlay">
...
.objViewer_shake {
	...
	border-radius: 500px;
	background-color: rgb(255, 255, 255);
	animation: objViewer_shaking 5s cubic-bezier(0.36, 0.07, 0.19, 0.97) both;
	transform: translate3d(0, 0, 0);
	animation-iteration-count: infinite;
}

@keyframes objViewer_shaking {
